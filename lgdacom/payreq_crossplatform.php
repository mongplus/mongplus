<?php
	...
	$LGD_EASYPAY_ONLY       = $_POST["LGD_EASYPAY_ONLY"];        	     //간편결제

    /* 가상계좌(무통장) 결제 연동을 하시는 경우 아래 LGD_CASNOTEURL 을 설정하여 주시기 바랍니다. */    
    $LGD_CASNOTEURL				= "http://".$_SERVER['HTTP_HOST']."/shop/order/cas_noteurl.php";    

    /* LGD_RETURNURL 을 설정하여 주시기 바랍니다. 반드시 현재 페이지와 동일한 프로트콜 및  호스트이어야 합니다. 아래 부분을 반드시 수정하십시요. */    
    $LGD_RETURNURL				= "http://".$_SERVER['HTTP_HOST']."/shop/order/returnurl.php";  
     ...
     *************************************************
     */
    require_once($_SERVER['DOCUMENT_ROOT']."/lgdacom/XPayClient.php");
